...
import numpy as np
RTE_tab = r'/home/ikirov/Retrotranscriptome/TEclassification7.tab' #r'D:\Programming\R_working\Tyrran_paper\TEclassification7.tab'
gff3 = r'/home/ikirov/Retrotranscriptome/Genes_TE_distance/20141217-Ha412v1r1.gff3' #r'sbs_20141217-Ha412v1r1.gff3'
...
def getRTEmiddleCoordinates(RTE_tab):
    ...
    with open(RTE_tab) as tab:
        for i, lines in enumerate(tab):
            if i != 0:
                sp = lines.split("\t")
                te_id, chromosome, middle = sp[0], \
                                            "Ha" + str(int(sp[1].split("|")[0])), \
...
def getGenePositionFromGff3(gff3, min_gene_len = 1000):
...
def main():
    ...
    Gene_middle_point, middle_point_Gene_id = getGenePositionFromGff3(gff3,min_gene_len=1000)
