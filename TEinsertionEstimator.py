...
class LTR_InsertionTimeCalculator():
    ...
    def __init__(self, fasta_LTR_left, fasta_LTR_right, outFile_tab, skip=False, r_parameter = 1E-08):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Script to estimate insertion time for LTR retrotranscposons")
    parser.add_argument("LTR5", help="5' LTR fasta")
    parser.add_argument("LTR3", help="3' LTR fasta")
    parser.add_argument("Output", help="Output file")
    parser.add_argument("-skip", "--skip", action='store_true' )
    parser.add_argument("-r", "--r", help="mutation rate", default=1E-08)

    args = parser.parse_args()

    LTR_InsertionTimeCalculator(args.LTR3, args.LTR5, args.Output, args.skip, args.r)